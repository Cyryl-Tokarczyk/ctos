CC := i686-elf-gcc
CFLAGS := -I include -m32 -ffreestanding -Wall -Wextra -Werror -c
...
iso/boot/kernel.elf: $(i386_OBJECT_FILES) $(KERNEL_OBJECT_FILES) src/linker.ld
	$(LD) $(LDFLAGS) $(i386_OBJECT_FILES) $(KERNEL_OBJECT_FILES) -o $@
